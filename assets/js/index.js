...
const registrar = [];
var totalGerado = false;

inpValor.value = '0.00';

const print = (valor, classe) => {
    if(totalGerado) {
        registro.innerHTML = ""; // pode colocar um botão para zerar, ou zerar automaticamente.
        totalGerado = false;
    }
...
window.addEventListener('keydown', (e) => {
    ...
    if(key === 'Backspace') tela.value = tela.value.slice(0,-1);
...
const impressao = () => {
    ...
    if(!totalGerado) print('Total: '+ inpValor.value);
